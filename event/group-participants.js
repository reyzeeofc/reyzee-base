...
export default async function GroupParticipants(reyzee, { id, participants, action }) {
   try {
      const metadata = await reyzee.groupMetadata(id)
      ...
      for (const jid of participants) {
         ...
         let profile
         try {
            profile = await reyzee.profilePictureUrl(jid, "image")
         } catch {
